"Implement Pem Shell history mechanism with History class"

from pem.config import pemConf


class History:
    ''' Implement Pem Shell history mechanism.
    ...
    def __init__(self, text):
        ...
        .text - Pem wrapper of tk Text widget, with .bell().
        ...
        self.prefix = None
        self.pointer = None
        self.cyclic = pemConf.GetOption("main", "History", "cyclic", 1, "bool")
...
if __name__ == "__main__":
    ...
    main('pem.pem_test.test_history', verbosity=2, exit=False)
